...
@section('judul', 'Admin | Manage Picture')
...
<div class="home-container mt-5">
    ...
    {{-- MENU BAR --}}
    <header>
        <h2 style="font-weight: bold"><i class="uil uil-apps"></i>Manage Pictures</h2>
    </header>
    <div class="header-hr">
        <hr>
    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-5">
                        <div class="card col-md-12 tea-content bg-light p-2">
                            ...
                            <form action="{{route('deletePictureAdmin',['id'=>$picture->id])}}" method="POST"
